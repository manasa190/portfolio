...
import { FileText, Code, Award, ArrowUpRight, Sparkles } from "lucide-react"
import AOS from 'aos'
...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      A passionate developer on a mission to build the future, one line of code at a time.
    </p>
  </div>
));
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold" data-aos="fade-right" data-aos-duration="1000">
              ...
              <span className="block mt-2 text-gray-200" data-aos="fade-right" data-aos-duration="1300">Manasa Sanjay</span>
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify pb-4 sm:pb-0" data-aos="fade-right" data-aos-duration="1500">
              A dedicated Computer Science student with a passion for turning complex problems into elegant, user-centric solutions. My expertise lies at the intersection of full-stack development and artificial intelligence, where I leverage cutting-edge technologies to build impactful and intelligent applications.
            </p>
            <div className="relative bg-gradient-to-br from-[#6366f1]/5 via-transparent to-[#a855f7]/5 border border-gradient-to-r border-[#6366f1]/30 rounded-2xl p-4 my-6 backdrop-blur-md shadow-2xl overflow-hidden" data-aos="fade-up" data-aos-duration="1700">
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Half engineer, half problem-solver, full-time learner."
              </blockquote>
            </div>
